...
class PhoneServerCallHoldTestCase(PzdfBaseTestCase):
    ...
    def test_200_call_hold(self):
        ...
        state = self.dial(resourceId="com.android.pzPhone:id/tv_activity_phone_main_state2").get_text()
        self.assertEqual(state, "保持中", "主叫保持失败")
        time.sleep(1)
        state = self.answer(resourceId="com.android.pzPhone:id/tv_activity_phone_main_state2").get_text()
